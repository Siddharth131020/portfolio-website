...
export default function RedoTextAnimation({ delay }: IRedoTextAnimationProps) {
  ...
  const texts = [
    ...
    "I am Electronics & Communication Engineering student from India.",
    "My primary interest lies in Software Development.",
    ...
    "Teamwork makes the dream work, lets build something amazing together!",
